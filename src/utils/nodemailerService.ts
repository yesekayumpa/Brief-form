...
const generateBriefPDF = (formData: BriefFormData, returnAsBlob: boolean = false) => {
  // Importer les modules localement pour éviter les erreurs
  ...
  // --- PAGE7: STRUCTURE & FONCTIONNALITÉS ---
...
const generatePDFBlob = async (formData: BriefFormData): Promise<Blob> => {
  try {
    // Utiliser directement la copie locale de generateBriefPDF avec returnAsBlob=true
