...
export default function App() {
  ...
  const isStepValid = () => {
    return true; // Toujours valide pour les tests
  };
  ...
  const nextStep = () => {
    if (isStepValid()) {
      ...
      const stepFields: (keyof FormData)[][] = [
        ...
        ['objectifPrincipal', 'ciblePrincipale', 'zonesGeographiques', 'messageCle', 'tonStyle'],
        ['budgetGlobal', 'delaiLivraison'],
        ['nomDomaineSouhaite', 'languesSite'],
        ['redacteurTextes', 'fournisseurVisuels', 'avezLogo', 'avezCharte'],
        ['pagesSouhaitees'],
        ['adaptabiliteMobile'],
        ['seoNaturel'],
            ...
            <div className="space-y-6 pt-12 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-white border border-slate-100 shadow-sm group hover:border-brand-red/20 transition-all">
                  ...
                  <p className="text-slate-600 text-xs font-bold group-hover:text-brand-dark transition-colors">+221 76 619 34 10</p>
                </div>
                <div className="p-4 rounded-2xl bg-white border border-slate-100 shadow-sm group hover:border-brand-red/20 transition-all">
