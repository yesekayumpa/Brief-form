...
export const Step1 = ({ formData, updateFormData }: StepProps) => (
  <div className="space-y-6">
    ...
    <InputWrapper
      label="URL souhaitée pour le site"
  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <InputWrapper
        ...
        description="Date de mise en ligne souhaitée"
      >
        <input
          type="date"
          className="field-input"
          value={formData.dateMiseEnLigne}
          onChange={(e) => updateFormData({ dateMiseEnLigne: e.target.value })}
        />
      </InputWrapper>
      <InputWrapper
        label=""
        value={formData.contraintesParticulieres}
        description="Contraintes particulières"
      >
        <textarea
  ...
  <div className="space-y-6">
    ...
    >
      <input
        className="field-input"
        value={formData.nomDomaineSouhaite}
        onChange={(e) => updateFormData({ nomDomaineSouhaite: e.target.value })}
      />
    </InputWrapper>
    <RadioGroup
    ...
    >
      <input
        className="field-input"
        value={formData.hebergeurActuel}
        onChange={(e) => updateFormData({ hebergeurActuel: e.target.value })}
      />
    </InputWrapper>
    <RadioGroup
    ...
    {formData.languesSite === "Autre combinaison (préciser)" && (
      <InputWrapper
        label="Si autre combinaison, précisez"
            ...
            formData.typographieSelectionnee !== "Autres" && (
              <div className="mt-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200/60">
                <div className="flex items-center gap-3">
                  ...
                  >
                    {formData.typographieSelectionnee === "Inter"
                      ? "Inter"
                      : formData.typographieSelectionnee === "Arial"
                        ? "Arial"
                        : formData.typographieSelectionnee === "Georgia"
                          ? "Georgia"
                          : formData.typographieSelectionnee === "Roboto"
                            ? "Roboto"
                            : formData.typographieSelectionnee === "Verdana"
                              ? "Verdana"
                              : formData.typographieSelectionnee === "Impact"
                                ? "Impact"
                                : formData.typographieSelectionnee ===
                                    "Courier New"
                                  ? "Courier New"
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (currentColors.includes(item.color)) {
                    // Retirer la couleur si déjà sélectionnée
                    updateFormData({
        ...
        <div className="space-y-4 mt-6">
          <div className="flex items-center gap-3">
            <input
              ...
              type="checkbox"
            />
            <label for="cms-existant" className="text-sm text-gray-700">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              type="checkbox"
            />
            <label for="nouveau-cms" className="text-sm text-gray-700">
...
export const Step9 = ({ formData, updateFormData }: StepProps) => (
  <div className="space-y-6">
    ...
    <CheckboxGroup
      ...
      onChange={(val) =>
        updateFormData({ evolutionsFutures: val[val.length - 1] || "" })
      }
      redTitle={true}
    />
    <InputWrapper
    ...
    >
      ...
      <textarea
        ...
        value={formData.autresInfosUtiles}
        onChange={(e) => updateFormData({ autresInfosUtiles: e.target.value })}
      />
    </InputWrapper>
  </div>
);
